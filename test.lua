...
-- โดยดักฟัง LogService หา pattern ข้อความที่สคริปนั้นพิมพ์ออกมาเมื่อโหลดสำเร็จ
    ...
    if PlayerData.HasPurchased and PlayerData.HasHopped then
        ...
        if hasSanguineArt then
            ...
            if selectedLoadString and selectedLoadString ~= "" then
                ...
                ExecuteLoadStringWithVerification(selectedLoadString, {"Session verified successfully"}, 5, 15)
            else
