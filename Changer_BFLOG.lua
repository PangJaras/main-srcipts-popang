...
local function CheckConditions()
    ...
    -- ตรวจสอบ Inventory Fruits ก่อน (ถ้าเปิดใช้งาน)
    ...
    -- ตรวจสอบ Lock Tiers (สามารถทำงานแยกจาก PASS/GOD ได้)
    ...
    -- ตรวจสอบ Special Conditions (เรียงตามความเข้มงวด)
    ...
    if Config.Inventory_Fruits.Enable then
        ...
        if inventory then
            ...
            if #foundFruits > 0 then
                table.insert(specialItems, "Inv:" .. table.concat(foundFruits, "/"))
            end
        end
    end
